...
final List<AppointmentData> appointments = [
  AppointmentData("01", "Tata Safari", "Raja Ram.", "Gen. Serv.", "10-11", AppointmentStatus.completed),
  AppointmentData("02", "Tata Curvv", "Hemant s.", "Repairing", "11-1", AppointmentStatus.inProgress),
  AppointmentData("03", "CT 100 ES", "Hemant s.", "Gen. Serv.", "1-2", AppointmentStatus.inProgress),
  AppointmentData("04", "Shine 125", "Bhupendr.", "Gen. Serv.", "2-3", AppointmentStatus.inProgress),
  AppointmentData("05", "Tata Safari", "Raja Ram.", "Gen. Serv.", "3-4", AppointmentStatus.completed),
  AppointmentData("06", "Tata Curvv", "Hemant s.", "Repairing", "4-6", AppointmentStatus.inProgress),
  AppointmentData("07", "CT 100 ES", "Hemant s.", "Gen. Serv.", "6-7", AppointmentStatus.inProgress),
  AppointmentData("08", "Tata Safari", "Raja Ram.", "Gen. Serv.", "7-8", AppointmentStatus.completed),
  AppointmentData("09", "Tata Curvv", "Hemant s.", "Repairing", "8-10", AppointmentStatus.inProgress),
  AppointmentData("10", "CT 100 ES", "Hemant s.", "Gen. Serv.", "10-11", AppointmentStatus.inProgress),
  AppointmentData("11", "Shine 125", "Bhupendr.", "Gen. Serv.", "Tom", AppointmentStatus.inProgress),
];

final List<MechanicData> mechanics = [
  MechanicData("01", "Mechanic one", "Working", "MP05\nMV6802", "10:30AM - 12:30PM"),
  MechanicData("02", "Mechanic one", "Idle", "-------", "----------------"),
  MechanicData("03", "Mechanic one", "Working", "MP05\nMV6802", "10:30AM - 12:30PM"),
  MechanicData("04", "Mechanic one", "Idle", "-------", "----------------"),
  MechanicData("05", "Mechanic one", "Working", "MP05\nMV6802", "10:30AM - 12:30PM"),
];
