...
class ReceptionistSettingsServices {
  void logoutReceptionist({required BuildContext context}) async {
    try {
      http.Response res = await http.get(
        Uri.parse('$uri/api/receptionistLogout'),
      );
  ...
  Future<void> changeReceptionistPassword({
    ...
    try {
      ...
      final response = await http.patch(
        Uri.parse('$uri/api/changeReceptionistPassword'),
        headers: {
