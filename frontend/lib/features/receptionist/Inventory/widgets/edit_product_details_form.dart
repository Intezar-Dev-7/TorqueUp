...
class _EditProductDetailsFormState extends State<EditProductDetailsForm> {
  ...
  void initState() {
    super.initState();
    productQuantityController = TextEditingController(text: widget.productQuantity.toString());
    productPriceController = TextEditingController(text: widget.productPrice.toString());
