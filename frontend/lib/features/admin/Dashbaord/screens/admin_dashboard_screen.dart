...
class _AdminDashboardScreenState extends State<AdminDashboardScreen> {
  ...
  Widget _buildStatsCards(double screenWidth) {
    ...
    final cardWidth = isSmallScreen
        ? (screenWidth - 36) / 2 // 2 cards per row on mobile
        : isTablet(screenWidth)
        ? (screenWidth - 56) / 3 // 3 cards per row on tablet
              ...
              Row(
                children: [
                  Icon(Icons.directions_car,
                      size: 16, color: AppColors.text_grey),
      ...
      child: Column(
        ...
        children: [
          ...
          ListView(
            ...
            physics: const NeverScrollableScrollPhysics(),
            children: [
              _buildInventoryItem('Engine Oil 5W-30', 45, true, isSmallScreen),
              _buildInventoryItem('Brake Pads Set', 8, false, isSmallScreen),
              _buildInventoryItem('Air Filter', 15, true, isSmallScreen),
              _buildInventoryItem('Spark Plugs', 32, true, isSmallScreen),
              _buildInventoryItem(
                  'Transmission Fluid', 6, false, isSmallScreen),
              _buildInventoryItem('Injector', 12, true, isSmallScreen),
            ],
          ),
        ],
      ),
  ...
  Widget _buildInventoryItem(
      String name, int qty, bool inStock, bool isSmallScreen) {
    return Container(
