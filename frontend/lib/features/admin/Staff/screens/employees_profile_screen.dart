...
class _EmployeesProfileScreenState extends State<EmployeesProfileScreen> {
  ...
  void initState() {
    super.initState();
    // Copy the staff object to local state so we can update the UI immediately
        ...
        child: Center(
          child: ConstrainedBox(
            ...
            child: Column(
              ...
              children: [
                _buildProfileHeader(currentStaff, screenWidth),
    ...
    return Column(
      ...
      children: [
        ...
        if (staff['staffContactNumber'] != null)
          _buildContactRow(Icons.phone_outlined, staff['staffContactNumber']),
        if (staff['staffEmail'] != null)
          _buildContactRow(Icons.email_outlined, staff['staffEmail']),
      ],
    );
  }
      ...
      child: ElevatedButton.icon(
        ...
        onPressed: () async {
          final updatedStaff = await showDialog<Map<String, dynamic>>(
            context: context,
            builder: (context) => EditEmployeeDialog(staff: currentStaff),
          );
          if (updatedStaff != null) {
            setState(() {
              currentStaff.addAll(updatedStaff);
            });
          }
        },
